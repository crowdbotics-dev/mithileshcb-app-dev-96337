import { rest_auth_password_reset_confirm_create } from "../../store/mithileshcbappdevAPI/passwordResetConfirms.slice.js";
  ...
  return <ScrollView>
      <View style={styles.container}>
        <View style={styles.headerContainer}>
          <ProfileImage />
          <Text style={styles.headerText}>{"Jay shivshankar"}</Text>
...
const Post = props => {
  return <TouchableHighlight onPress={props.onPress} style={postStyles.galleryPost} underlayColor="#DDDDDD">
      <Image style={postStyles.editIcon} source={require("./sachin.jpeg")} />
    </TouchableHighlight>;
};
