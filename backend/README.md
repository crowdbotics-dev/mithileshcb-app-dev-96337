...
## Project Structure
    ...
    ├── mithileshcb_app_dev_96337  # Django project configurations
...
1. Clone this repo and `cd mithileshcb_app_dev_96337`
...
2. Clone this repo and `cd mithileshcb_app_dev_96337`
